...
import justkhelo.cricks.models.ImageSliderData
import justkhelo.cricks.models.MatchBannersModel

class PredictBannerAdapter(context: Context, private val imageSliderDataList: ArrayList<ImageSliderData>): PagerAdapter() {
    var mContext: Context = context
    private var arrayList = imageSliderDataList
